package com.travellingdealer.omernasuhi
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        addCustomerToListBtn = findViewById(R.id.btAddCustomerToList)
        sumOfNodesBtn = findViewById(R.id.btSumOfNodes)
        printList = findViewById(R.id.btShowList)
        printLengthOfListBtn = findViewById(R.id.btPrintLenghtOfList)
        deleteNodeBtn = findViewById(R.id.btDeleteNode)
        clearListBtn = findViewById(R.id.btClearList)
        historyOfListTxt = findViewById(R.id.historyOfListTxt)
        clearHistoryBtn = findViewById(R.id.btClearHistory)
